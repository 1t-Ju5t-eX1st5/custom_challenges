...
def janken_hoi(P1_move: str, P2_move: str) -> str:
    if P1_move == "" or P2_move == "": # In challenge, was shown as ... == "" and P2_move == ""
        return "Invalid choice selected"
        ...
        if P1_standard == P2_standard:
            return "Tie"
        elif (P1_standard == "scissors" and P2_standard == "paper") or (P1_standard == "paper" and P2_standard == "stone") or (P1_standard == "stone" and P2_standard == "scissors"): # Two == signs were swapped with = signs
        ...
        # Expected results for conditional statements 2 and 3 were flipped
        else:
            print(P1_move, P2_move)
            print(P1_standard, P2_standard)
            return "Invalid choice selected"
